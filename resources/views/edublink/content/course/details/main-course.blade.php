                ...
                <div class="course-details-content course course-details-4">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" href="#overview-tab-id">Overview</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" href="#carriculam-tab-id">Carriculam</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" href="#instructor-tab-id">Instructor</a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a class="nav-link" href="#review-tab-id">Reviews</a>
                        </li>
                    </ul>
                            ...
                            <div class="course-tab-content">
                                <div class="course-overview">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                        inc idid unt ut labore et dolore magna aliqua enim ad minim veniam, quis nostrud
                                        exerec tation ullamco laboris nis aliquip commodo consequat duis aute irure
                                        dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                                        pariatur enim ipsam.</p>
                                    <p class="mb--60">Excepteur sint occaecat cupidatat non proident sunt in culpa qui
                                    ...
                                    <p>Consectetur adipisicing elit, sed do eiusmod tempor inc idid unt ut labore et
                                        dolore magna aliqua enim ad minim veniam quis nostrud exerec tation ullamco
                                        laboris nis aliquip commodo consequat duis aute irure dolor.</p>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="carriculam-tab-id">
                            <div class="course-tab-content">
                                <div class="course-curriculam">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                        inc idid unt ut labore et dolore magna aliqua enim ad minim veniam, quis nostrud
                                        exerec tation ullamco laboris nis aliquip commodo consequat.</p>
                                    <div class="course-lesson">
                                        <h5 class="title">Week 1-4</h5>
                                        <p>Advanced story telling techniques for writers: Personas, Characters & Plots
                                        </p>
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <div class="text"><i class="icon-65"></i> Local Development Environment
                                                    Tools</div>
                                            ...
                                            <li>
                                                <div class="text"><i class="icon-65"></i> Course Exercise / Reference
                                                    Files</div>
                                                <div class="icon"><i class="icon-68"></i></div>
                                            </li>
                                            <li>
                                                <div class="text"><i class="icon-65"></i> Code Editor Installation
                                                    (Optional if you have one)</div>
                                                <div class="icon"><i class="icon-68"></i></div>
                                            </li>
                                            <li>
                            ...
                            <div class="course-tab-content" id="instructor-tab-id">
                                <div class="course-instructor">
                                    ...
                                    <div class="author-content">
                                        ...
                                        <p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt labore et
                                            dolore magna aliqua enim minim veniam quis nostrud exercitation ulla mco
                                        ...
                                        <form class="comment-form">
                                            <div class="row g-5">
                                                <div class="form-group col-lg-6">
                                                    <input type="text" name="comm-title" id="comm-title"
                                                ...
                                                <div class="form-group col-12">
                                                    <textarea name="comm-message" id="comm-message" cols="30" rows="5"
